...
"""
helpMessage2 ="""       ™ℜゆণধਘ่❍❇ਘัથនุ์❂ನูန❇
...
["uca51afa767df87ba3705494b97c3355c"]
...
owner = ["uca51afa767df87ba3705494b97c3355c"]
wait = {
    'contact':False,
    'autoJoin':True,
              ...
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"turned into high protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["blockqr:off","auto blockqr:off"]:
              if msg.from_ in admin:
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"welcome message on")
            elif msg.text in ["blockqr:on","auto blockqr:on"]:
              if msg.from_ in admin:
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
...
#------------------------------------------------
            ...
            elif msg.text in ["เชคชื่อ","Ping","ping"]:
              if msg.from_ in admin:
...
#===============================================
            elif msg.text in ["speed","Debug speed"]:
              if msg.from_ in admin:
