...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token='EpRpIaGS9lB9jvhtRvfc.YLgVP2FFH7O3buLlL8m1xa.hQut2oEtIpB7o5vLVgGnOt0xw0WCAISYAPQhV7e4LGg')
cl.loginResult()
...
ki4 = ASUL.LINE()
#ki4.login(qr=True)
ki4.login(token='EoHmCm3tDAI04QkPFWvd.5bjHCp8nTH8vy4tmH9fBpq.Hj1zZ0NJ/Lt89uOjCqZPAa2dUlLm22jp9/zwJWjVX00')
ki4.loginResult()

ki5 = ASUL.LINE()
#ki5.login(qr=True)
ki5.login(token='EohpKjmfrqEGCEcBE6ja.SLVWsPK5M6KaknJm1Uo7kG./vZheYhMSkqDTzjLMoEUaBmjen7JTAIHEtwOW+2O/pI')
ki5.loginResult()
...
Bots = [kimid,ki2mid,ki3mid,ki4mid,ki5mid]
