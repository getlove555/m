...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token='EpMaiiJEbzr1Ykgu2qdc.YLgVP2FFH7O3buLlL8m1xa.QV6LVSI5mt96YXQGZZiegkyWOE9GLPwF7T5m7MuUkjY')
cl.loginResult()
ki=ki2=ki3=ki4=ki5=cl

ki = ASUL.LINE()
#ki.login(qr=True)
ki.login(token='EpcnE069Ym1UkUXzAgt7.Cwyg1tG1cekJ45Kzw9aWLW.X9anJpCYwUKZsq4HIv1En5VYK38yb5S1lr5VF99c5yk')
ki.loginResult()
